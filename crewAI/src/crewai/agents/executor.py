...
from crewAI.src.crewai.agents.cache.cache_hit import CacheHit
from crewAI.src.crewai.tools.cache_tools import CacheTools
from crewAI.src.crewai.utilities import I18N
...
class CrewAgentExecutor(AgentExecutor):
    ...
    def set_force_answer_max_iterations(cls, values: Dict) -> Dict:
        values["force_answer_max_iterations"] = values["max_iterations"] 
        return values

    def _should_force_answer(cls) -> bool:
        return True if cls.iterations == cls.force_answer_max_iterations else False
